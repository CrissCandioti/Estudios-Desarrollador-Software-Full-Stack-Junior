 ...
 */
public class EjercicioExtraHerencia2 {

    /**
     * @param args the command line arguments
     */
    public static void main(String[] args) {
        Auto A1 = new Auto("Ford", "Wa42", "Naftero");
        Viaje viaje1 = new Viaje("San Luis", "Rufino", 200, true, "Naftero", A1, 700, 2500);
        System.out.println("El costo total del viaje es: " + viaje1.costoTotal());
    }
