 ...
 */
public class EjercicioColecciones4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("A continuacion le pediremos que ingrese la o las peliculas");
        System.out.println("Recordemos que no se admiten peliculas repetidas");
